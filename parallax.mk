...
$(call inherit-product, vendor/parallax/config/gsm.mk)
...
$(call inherit-product, vendor/parallax/config/common_full_phone.mk)

# Enhanced NFC
$(call inherit-product, vendor/parallax/config/nfc_enhanced.mk)
